...
package com.vibevault.app.utils.cipher
...
import com.vibevault.app.constants.CipherLastUpdatedKey
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                try {
                                    CipherDeobfuscator.appContext.dataStore.edit {
                                        it[com.vibevault.app.constants.CipherLastUpdatedKey] = System.currentTimeMillis()
                                    }
                                } catch (e: Exception) {
