...
private fun drawCollage(
    ...
    val squares = summary.songs.mapNotNull { it.song.albumImageUrl.takeIf { url -> url.isNotBlank() } }.distinct().take(3)
...
private fun drawHeader(
    ...
    canvas.drawText("VibeVault", POSTER_W - MARGIN, 132f, brand)
...
private fun drawFooter(canvas: Canvas, type: Fonts) {
    canvas.drawText(
        "Counted on device with VibeVault",
        MARGIN,
        POSTER_H - 64f,
