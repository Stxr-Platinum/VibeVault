...
/**
 * BitChord / iOS style sleek scrub and volume slider.
 * Thickens responsively under finger touch and settles back smoothly on release.
 */
@Composable
fun BitChordThinSlider(
    value: Float,
