...
package com.vibevault.app.data.listentogether
...
import com.vibevault.app.constants.ListenTogetherAutoApprovalKey
import com.vibevault.app.constants.ListenTogetherIsHostKey
import com.vibevault.app.constants.ListenTogetherRoomCodeKey
import com.vibevault.app.constants.ListenTogetherServerUrlKey
import com.vibevault.app.constants.ListenTogetherSessionTimestampKey
import com.vibevault.app.constants.ListenTogetherSessionTokenKey
import com.vibevault.app.constants.ListenTogetherUserIdKey
import com.vibevault.app.utils.NetworkConnectivityObserver
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.vibevault.app.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.vibevault.app.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.vibevault.app.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.vibevault.app.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.vibevault.app.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.vibevault.app.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
