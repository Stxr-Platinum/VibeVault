...
-keep,includedescriptorclasses class com.vibevault.app.**$$serializer { *; }
-keepclassmembers class com.vibevault.app.** {
    *** Companion;
}
-keepclasseswithmembers class com.vibevault.app.** {
    kotlinx.serialization.KSerializer serializer(...);
}
